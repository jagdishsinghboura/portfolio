...
const Navbar = () => {
  ...
  return (
    <div   className={`w-full md:flex md:justify-center   sticky top-0  z-50 border-b-1 md:border-none p-2 dark:text-white text-black font-bold border-b-gray-500  bg-white dark:bg-slate-900   shadow-lime-600 `}>
      ...
      <div onMouseLeave={handleIsActive} className={` absolute rounded-xl  top-16 right-2 backdrop-blur-xl bg-slate-100  dark:bg-slate-600 md:bg-slate-900 md:static w-2/5 md:w-3/4 text-slate-300 md:flex flex-col md:flex-row gap-4 md:justify-around md:rounded-b-md font-sans p-4 md:border-b-1 shadow-2xl  ${isActive==true?"hidden":""}`}>
